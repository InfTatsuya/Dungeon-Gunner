...
public static class Settings
{
    ...
    public const float doorUnlockDelay = 1f; //Time to unlock the door after room is cleared.
    #endregion

    #region ANIMATOR PAREMETERS
    ...
    public const float useAimAngleDistance = 3.5f; //if the target distance is less than
                                                   //this then the aim angle will be used (from player), else the weapon aim angle
