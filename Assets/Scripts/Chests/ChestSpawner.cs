...
public class ChestSpawner : MonoBehaviour
{
    ...
    [Tooltip("The weapons to spawn for each level ang their spawn ratios")]
    ...
    private void SpawnChest()
    {
        ...
        {
            Vector3 spawnPosition = HelperUtilities.GetSpawnPositionNearestToPlayer(GameManager.Instance.GetPlayer().GetPlayerPosition());
    ...
    private void GetItemsToSpawn(out int ammoNum, out int healthNum, out int weaponNum)
    {
        ...
        else if(numberOfItemsToSpawn == 2)
        {
            ...
            if (choice == 2) { healthNum++; weaponNum++; return; }
        }
