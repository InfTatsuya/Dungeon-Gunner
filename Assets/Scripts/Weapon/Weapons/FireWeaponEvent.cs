...
public class FireWeaponEvent : MonoBehaviour
{
    ...
    public void CallFireWeaponEvent(bool fire, bool firePreviousFrame, AimDirection aimDir, float aimAngle, float weaponAimAngle, Vector3 weaponAimDirectionVector)
    {
