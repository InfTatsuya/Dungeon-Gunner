...
[CreateAssetMenu(fileName ="AmmoHitEffect_", menuName ="SO/Weapons/Ammo Hit Effect")]
public class AmmoHitEffectSO : ScriptableObject
{
    [Space(10)]
    [Header("AMMO HIT EFFECT DETAILS")]

    [Tooltip("The color gradient for effect")]
    public Gradient colorGradient;

    [Tooltip("The duration of effect")]
    ...
    [Tooltip("The prefab of AmmoHitEffect")]
